...
public class StudentInfo extends AppCompatActivity implements NavigationDrawerFragment.OnFragmentInteractionListener{
     ...
     */
    private MobileServiceSyncTable<StudentListItem> mToDoTable;
...
//    }
        ...
        AsyncTask<Void, Void, Void> task = new AsyncTask<Void, Void, Void>(){
            ...
            protected Void doInBackground(Void... params) {
                ...
                try {
                    ...
                    //Offline Sync
                    final List<StudentListItem> results = refreshItemsFromMobileServiceTableSyncTable();
  ...
  /* private List<StudentListItem> refreshItemsFromMobileServiceTable() throws ExecutionException, InterruptedException {
     ...
     */
    private List<StudentListItem> refreshItemsFromMobileServiceTableSyncTable() throws ExecutionException, InterruptedException {
        //sync the data
        sync().get();
        ...
        AsyncTask<Void, Void, Void> task = new AsyncTask<Void, Void, Void>() {
            ...
            protected Void doInBackground(Void... params) {
                try {
                    ...
                    tableDefinition.put("rollno", ColumnDataType.String);
                    tableDefinition.put("name", ColumnDataType.String);
                    tableDefinition.put("fname", ColumnDataType.String);
                    tableDefinition.put("coursecode", ColumnDataType.String);
                    tableDefinition.put("session", ColumnDataType.String);
                    tableDefinition.put("branchcode", ColumnDataType.String);
                    tableDefinition.put("email", ColumnDataType.String);

                    localStore.defineTable("StudentListItem", tableDefinition);
